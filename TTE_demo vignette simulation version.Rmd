...
```{r}
model_cens_pool_n=prep_ITT_data$censor_models$cens_pool_n
...
model.pp.cens.d0=readRDS("C:/Users/u0399057/Box/Private/Kevin Ying/TTE vignette/cense_model_d0.rds")
...
model.pp.cens.d1=readRDS("C:/Users/u0399057/Box/Private/Kevin Ying/TTE vignette/cense_model_d1.rds")
...
model.pp.switch.n0=readRDS("C:/Users/u0399057/Box/Private/Kevin Ying/TTE vignette/weight_model_switch_n0.rds")
...
model.pp.switch.n1=readRDS("C:/Users/u0399057/Box/Private/Kevin Ying/TTE vignette/weight_model_switch_n1.rds")
...
model.pp.switch.d0=readRDS("C:/Users/u0399057/Box/Private/Kevin Ying/TTE vignette/weight_model_switch_d0.rds")
...
model.pp.switch.d1=readRDS("C:/Users/u0399057/Box/Private/Kevin Ying/TTE vignette/weight_model_switch_d1.rds")
...
time.switch=  data_censored_simp_PP4 %>%filter(art_censored==1)%>%group_by(id)%>%
  summarise(t.switch=min(month))%>%ungroup()
data_censored_simp_PP5  <- data_censored_simp_PP4 %>% left_join(time.switch, by = "id") 
 data_censored_simp_PP6=data_censored_simp_PP5%>% filter(month<=t.switch | is.na(t.switch))  
